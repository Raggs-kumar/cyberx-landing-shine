...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "CYBERX — Next-Gen Cybersecurity" },
      { name: "description", content: "AI-powered threat detection, cloud security, and incident response." },
      { name: "author", content: "CYBERX" },
